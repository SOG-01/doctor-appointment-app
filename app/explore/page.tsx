  ...
  return (
    <div>
      <div className="overflow-hidden w-full">
        <p className="inline-block animate-bounce-left-right text-lg">
          find nearest clinic to you and get direction to the clinic
        </p>
      </div>
      ...
      <style jsx>{`
        ...
        .animate-bounce-left-right {
          animation: bounce-left-right 12s ease-in-out infinite;
        }
      `}</style>
                ...
                {clinic.type === "registered" ? (
                  <div className="flex flex-col">
                    <button
                      className="mb-2"
                      onClick={() =>
                        alert("Booking appointment for " + clinic.name)
                      }
                    >
                      Book Appointment
                    </button>
                    <button
                      onClick={() => getDirections(clinic.lat, clinic.lng)}
                    >
                      Get Directions
                    </button>
                  </div>
